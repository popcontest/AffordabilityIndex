    ...
    <div className="relative overflow-hidden bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 rounded-2xl p-12 border-2 border-blue-200 shadow-xl hover:shadow-2xl transition-all duration-300" data-testid="score-hero">
      <div className="text-center relative z-10">
        ...
        <div className="text-base text-gray-600 mb-2">
          <strong>Higher scores = more affordable.</strong> Combines housing, food, healthcare, and transportation costs.
        </div>
        ...
        {/* Quick insights - 3 bullet points max */}
        <div className="text-sm text-gray-700 space-y-2 max-w-2xl mx-auto mb-8">
          <div className="flex items-start gap-2">
            <span className="text-ai-warm font-bold">•</span>
            <span>More affordable than <strong>{Math.round(overallScore)}%</strong> of US cities</span>
          </div>
          <div className="flex items-start gap-2">
            <span className="text-ai-warm font-bold">•</span>
            <span>Homes cost <strong>{((5 - (overallScore / 20)).toFixed(1))}×</strong> median income (vs 4.5× national avg)</span>
          </div>
          <div className="flex items-start gap-2">
            <span className="text-ai-warm font-bold">•</span>
            <span>{overallScore >= 60 ? 'Great for' : 'Consider for'} {overallScore >= 60 ? 'families & retirees' : 'budget-conscious buyers'}</span>
          </div>
        </div>
